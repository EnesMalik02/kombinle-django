    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.CharField(choices=[('Türkiye', 'Türkiye'), ('ABD', 'ABD'), ('Fransa', 'Fransa')], max_length=100, verbose_name='Ülke')),
                ('gender', models.CharField(choices=[('Erkek', 'Erkek'), ('Kadın', 'Kadın')], max_length=10, verbose_name='Cinsiyet')),
